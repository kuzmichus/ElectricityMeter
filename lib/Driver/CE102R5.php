...
class CE102R5 extends EMDriver
{
    ...
    const CMD_PING                = 0x0001;
    const CMD_READ_SERIAL_NUMBER  = 0x011A;
    const CMD_READ_DATE_TIME      = 0x0120;
    const CMD_READ_BAT_RES        = 0x0126;
    const CMD_READ_CUR_TARIFF     = 0x012D;
    const CMD_READ_POWER          = 0x0132;
    const CMD_READ_ENERGY_OF_DAYS = 0x0133;
    const CMD_READ_JOURNAL_EVENT  = 0x0138;

    const addrD  = 0x0594;
    const addrS  = 0xFD;
    const passwd = 0x00000000;

    private $crc8tab = array(
